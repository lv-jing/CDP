...
const Action = (props) => {
    useEffect(() => {
        let subData = props.data.filter(x=>x.subClassification === '33')
    ...
    useEffect(() => {
        let subData = props.data.filter(x=>x.subClassification === '34')
    ...
    return (
        <div className="bg-white p-20-40">
            <div className="title">{props.title}-活动偏好</div>
            <Row>
                <Col md={12}>
                    <div id="content" className="top4-chart"></div>
                </Col>
                <Col md={12}>
                    <div id="mechanism" className="top4-chart"></div>
                </Col>
            </Row>
        </div>
    )
